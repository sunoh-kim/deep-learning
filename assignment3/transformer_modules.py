...
class Hparams:
    ...
    parser.add_argument('--logdir', default="./transformer_checkpoints", help="log directory")
    # DEFINE 5
    parser.add_argument('--num_epochs', default=10, type=int) 
    parser.add_argument('--evaldir', default="./transformer_checkpoints/eval", help="evaluation dir")

    # model
    # DEFIN
    parser.add_argument('--d_model', default=120, type=int,
    ...
    parser.add_argument('--testdir', default="./transformer_checkpoints/test", help="test result dir")
